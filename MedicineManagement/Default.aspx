...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="BtnAdminLogin" CssClass="btn btn-primary" runat="server" Text="Admin Login" OnClick="BtnAdminLogin_Click" />
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="images\home.jpg" alt="Los Angeles" />
    </div>
...
we can avoid the difficulty to maintain the medicine details and bill and patientdetails. 
    ...
    To overcome the above problems, the current project is developed.</p>
